...
main (int argc, char *argv[])
{
  ...
  QCoreApplication::setApplicationName ("crawl");
  deliberate::ProgramVersion pv ("Crawl");
  ...
  deliberate::CmdOptions  opts ("crawl");
  ...
  openmielke::Crawl   crawl;

  app.setWindowIcon (crawl.windowIcon());
  crawl.Init (app);
  crawl.AddConfigMessages (configMessages);
